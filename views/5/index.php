...
<script type="text/javascript" src="lightbox.min.js" rel="stylesheet"></script>
<script type="text/javascript" src="lightbox.css" rel="stylesheet" type="text/css"></script>
<script type="text/javascript" src="https://apis.google.com/js/client.js?onload=checkAuth"></script>
<script type="text/javascript" src="upload.js"></script>
<script type="text/javascript" src="google-drive.js"></script>
<script type="text/javascript" src="google-drive.css" rel="stylesheet" type="text/css"></script>




<style>
<?php include 'google-drive.css'; ?>
</style>
...
<div id="drive-box" class="hide">
    ...
    <div id="drive-info" class="hide">
        ...
        <div class="user-item"><a id="link-logout" class="logout-link" href="https://accounts.google.com/logout">Logout</a></div>
    </div>
